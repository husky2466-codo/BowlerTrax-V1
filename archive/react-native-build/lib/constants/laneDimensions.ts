...
/**
 * Shorthand lane constants for easy access
 */
export const LANE = {
  LENGTH_FEET: 60,
  WIDTH_INCHES: 41.5,
  BOARD_COUNT: 39,
  BOARD_WIDTH_INCHES: 1.0641,
  ARROWS_DISTANCE_FEET: 15,
  POCKET_BOARD_RH: 17.5,
  POCKET_BOARD_LH: 22.5,
};

/**
 * Optimal entry angle for strikes (6 degrees)
 */
export const OPTIMAL_ENTRY_ANGLE = 6;
